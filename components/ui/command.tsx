...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex cursor-default gap-2 select-none items-center rounded-md px-2 py-2 text-sm outline-none',
      'data-[selected=true]:bg-ouro-50 data-[selected=true]:text-ouro-900',
