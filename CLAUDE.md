...
This project is indexed by GitNexus as **feiraoMoveis** (810 symbols, 1445 relationships, 45 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/feiraoMoveis/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/feiraoMoveis/context` | Codebase overview, check index freshness |
| `gitnexus://repo/feiraoMoveis/clusters` | All functional areas |
| `gitnexus://repo/feiraoMoveis/processes` | All execution flows |
| `gitnexus://repo/feiraoMoveis/process/{name}` | Step-by-step execution trace |
